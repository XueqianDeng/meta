...
class VectorModel:
    ...
    def get_Vector(self):
        ...
        self.vector_4 = unit_vector(np.loadtxt('data/vector_3.csv', delimiter=','))
    ...
    def predict(self, input_array):
        ...
        x_axis = 0
        y_axis = 0
        x_axis = np.linalg.norm(vector_1_projection * np.cos(vector_1_angle)) + np.linalg.norm(vector_2_projection * np.cos(vector_2_angle))
        x_axis += np.linalg.norm(vector_3_projection * np.cos(vector_3_angle)) + np.linalg.norm(vector_4_projection * np.cos(vector_4_angle))
        y_axis = np.linalg.norm(vector_1_projection * np.sin(vector_1_angle)) + np.linalg.norm(vector_2_projection * np.sin(vector_2_angle))
        y_axis += np.linalg.norm(vector_3_projection * np.sin(vector_3_angle)) + np.linalg.norm(vector_4_projection * np.sin(vector_4_angle))
        print("x_axis", x_axis)
