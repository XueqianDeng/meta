...
class VectorModel:
    ...
    def get_Vector(self):
        self.vector_1 = unit_vector(np.loadtxt('data/vec_1.csv', delimiter=','))
        self.vector_2 = unit_vector(np.loadtxt('data/vec_2.csv', delimiter=','))
        self.vector_3 = unit_vector(np.loadtxt('data/vec_3.csv', delimiter=','))
        self.vector_4 = unit_vector(np.loadtxt('data/vec_4.csv', delimiter=',')) ##   correction 1
